...
def pregunta_01():
    ...
    # Ruta del archivo
    file_path = r'C:\Users\DELL\OneDrive\Escritorio\Especialización\Analitica Descriptiva\2024-2-PRE-03-ingestion-de-texto-plano-carolinacgj\files\input\clusters_report.txt'
